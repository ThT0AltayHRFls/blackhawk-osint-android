...
namespace BlackHawk.Views.Pages
{
    ...
    public partial class EnhancedPage3 : ContentPage
    {
        public EnhancedPage3()
        {
            InitializeComponent();
            BuildUI();
        }
        ...
        private void BuildUI()
        {
            ...
            var header = new Frame
            {
                ...
                Content = new Label { Text = "Sayfa 3", FontSize = 22, FontAttributes = FontAttributes.Bold, TextColor = Color.FromHex("#00D9FF") }
            };
            ...
            var contentCard = new Frame
            {
                ...
                Content = new StackLayout
                {
                    ...
                    Children =
                    {
                        new Label { Text = "İçerik 3", FontSize = 16, FontAttributes = FontAttributes.Bold, TextColor = Color.White },
