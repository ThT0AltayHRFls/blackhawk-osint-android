...
namespace BlackHawk.Views.Pages
{
    ...
    public partial class EnhancedPage5 : ContentPage
    {
        public EnhancedPage5()
        {
            InitializeComponent();
            BuildUI();
        }
        ...
        private void BuildUI()
        {
            ...
            var header = new Frame
            {
                ...
                Content = new Label { Text = "Sayfa 5", FontSize = 22, FontAttributes = FontAttributes.Bold, TextColor = Color.FromHex("#00D9FF") }
            };
            ...
            var contentCard = new Frame
            {
                ...
                Content = new StackLayout
                {
                    ...
                    Children =
                    {
                        new Label { Text = "İçerik 5", FontSize = 16, FontAttributes = FontAttributes.Bold, TextColor = Color.White },
